...
### Sunset Lights App
This SmartApp turns on selected lights at sunset and turns them off at a specified time. Different turn-off times can be configured for each day of the week, and they can be randomized within a specified window to simulate manual operation.
