...
This SmartApp sends a push notification when a lock gets unlocked (can specify during which modes), or if the door is left unlocked when the mode changes.
