...
## Contributors
This SmartApp was adapted for my personal requirements from the example written by Jason Steele, with the usage instructions and code found at https://www.grovestreams.com/developers/getting_started_smartthings.html
