...
*/
definition(
    name: "Switches on Motion",
    namespace: "astrowings",
    author: "Phil Maynard",
    description: "Parent app for 'Switch on Motion'",
...
private		readmeLink()			{ return "https://github.com/astrowings/SmartThings/blob/master/smartapps/astrowings/switches-on-motion.src/readme.md" }
