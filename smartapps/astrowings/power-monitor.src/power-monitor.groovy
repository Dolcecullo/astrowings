    ...
    dynamicPage(name: "pageMain", install: true, uninstall: false) {
        ...
        section("Select power thresholds") {
			if (thePower) {
                ...
                input "loDuration", "number", title: "Duration for low power", description: "Optionally, set the minimum time (minutes) " +
                ...
                input "hiDuration", "number", title: "Duration for high power", description: "Optionally, set the minimum time (minutes) " +
...
def checkPower(w) {
    ...
    if (hiPower && w > hiPower) {
    	...
    	debug "power draw of ${w} watts is within set limits (${loPower} - ${loPower} W); unschedule rechecks and wait for next trigger", "debug"
        state.warnState = 0  // 0=ok, 10=low power warning triggered, 11=low power grace period, 20=high power warning triggered, 21=high power grace period
